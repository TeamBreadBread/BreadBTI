...
export const MBTI_PROFILE_MAP: Record<MbtiType, MbtiProfile> = {
  ...
  INTP: {
    ...
    description:
      '겉보기엔 평범하지만 어떤 형태로든 변신 가능. 생각이 많고 논리적인 아이디어 뱅크.',
    goodMatches: [
  ...
  ENTJ: {
    ...
    oneLine: '단단한 리더',
    description:
      '목표 지향적이고 추진력 강한 타입. 쉽게 휘어지지 않는 강한 멘탈의 소유자.',
    goodMatches: [
  ...
  ENTP: {
    ...
    description:
      '틀에 얽매이지 않는 자유로운 사고. 장난기 + 창의력 폭발형.',
    goodMatches: [
      { mbti: 'INFP', bread: '컵케이크' },
      { mbti: 'ENFP', bread: '도넛' },
    ],
  ...
  INFJ: {
    ...
    oneLine: '부드럽고 깊은 감성',
    description:
      '조용하지만 깊은 내면을 가진 타입. 사람을 잘 이해하고 공감 능력이 뛰어나다.',
    goodMatches: [
      { mbti: 'ENTJ', bread: '바게트' },
  ...
  ENFJ: {
    ...
    oneLine: '모두를 챙기는 리더',
    description:
      '주변 사람들을 잘 챙기고 분위기를 이끈다. 함께 있을 때 가장 빛나는 타입.',
    goodMatches: [
      { mbti: 'ENTJ', bread: '바게트' },
      { mbti: 'INTJ', bread: '크로와상' },
    ],
  ...
  ESFJ: {
    ...
    oneLine: '부드러운 인기쟁이',
    description:
      '친화력 좋고 사람들과 잘 어울림. 어디서든 사랑받는 스타일.',
    goodMatches: [
      { mbti: 'ENFJ', bread: '생크림케이크' },
      { mbti: 'ISFJ', bread: '베이글' },
    ],
